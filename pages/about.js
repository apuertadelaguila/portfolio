...
const About = () => {
    ...
    return (
        ...
        <div className="about" data-aos="fade-down">
            <h1>Who I am</h1>
            <p><b>Junior Front-end Developer based in Berlin!</b></p>
            <p>My name is Alejandro Puerta and after 7 years working as nurse in Germany I decided to go back to my childhood and continue my passion for computers and technology.</p>
